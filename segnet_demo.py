...
cap = cv2.VideoCapture('/workspace/in/%06d.jpg') # Change this to your webcam ID, or file name for your video file
...
while rval:
	...
	print '%30s' % 'Processed results in ', str((end - start)*1000), 'ms\n'
        ...
        rgbfile = '/workspace/out/in_%03d.png' % count
        cv2.imwrite(rgbfile, frame)

        segfile = '/workspace/out/segnet_%03d.png' % count
